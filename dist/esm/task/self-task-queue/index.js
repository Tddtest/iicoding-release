...
// 修改 script 执行提交脚本
var machiningPkg = function machiningPkg(record) {
  record.scripts = _objectSpread(_objectSpread({}, record.scripts), {}, {
    "push": "node script.js"
  });
...
/**
 * 笔者自己的 release 流，基于 git 仓库 中的 git submodule 多仓库处理。
 * @param targetDir
 * @param namespace
 */
export var gitSubmoduleRelease = function gitSubmoduleRelease(targetDir, namespace) {
  return composeTaskQueue(getTaskQueue(targetDir, namespace));
};